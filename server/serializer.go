...
func GetAddBookPayloadFromJSON(data io.Reader) (*AddAPIRequest, error) {
	body := &AddAPIRequest{}
	if err := json.NewDecoder(data).Decode(&body); err != nil {
		return nil, err
	}
...
func GetEditBookPayloadFromJSON(data io.Reader) (*EditAPIRequest, error) {
	body := &EditAPIRequest{}
	if err := json.NewDecoder(data).Decode(&body); err != nil {
		return nil, err
	}
...
func GetCompleteBookPayloadFromJSON(data io.Reader) (*CompleteAPIRequest, error) {
...
func GetRemoveBookPayloadFromJSON(data io.Reader) (*RemoveAPIRequest, error) {
...
func GetBumpBookPayloadFromJSON(data io.Reader) (*BumpAPIRequest, error) {
	body := &BumpAPIRequest{}
	if err := json.NewDecoder(data).Decode(&body); err != nil {
		return nil, err
	}
